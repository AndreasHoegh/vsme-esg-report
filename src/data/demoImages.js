...
function makeLogo() {
  ...
  ctx.beginPath();
  ctx.arc(260, 70, 150, 0, Math.PI * 2);
  ctx.fill();
...
function makeEnergyChart() {
  ...
  energy.forEach((d, i) => {
    ...
    rrect(ctx, 140, y, barMaxW, barH, 4);
    ctx.fill();

    // Bar
    ctx.fillStyle = d.color;
    rrect(ctx, 140, y, Math.max(bw, 8), barH, 4);
    ctx.fill();
  ...
  rrect(ctx, pillX, pillY, 120, 18, 9);
  ctx.fill();
  ctx.fillStyle = GREEN;
  ctx.font = "bold 10px Arial";
  ...
  ghg.forEach((d, i) => {
    ...
    ctx.fillStyle = "#f1f5f9";
    rrect(ctx, 68, y, ghgMaxW, ghgH, 3);
    ctx.fill();

    ctx.fillStyle = d.color;
    rrect(ctx, 68, y, Math.max(bw, 6), ghgH, 3);
    ctx.fill();
...
function makeWorkforceChart() {
  ...
  ctx.beginPath();
  ctx.moveTo(cx, cy);
  ctx.arc(cx, cy, r, start, start + mAngle);
  ctx.closePath();
  ctx.fill();
  ...
  ctx.beginPath();
  ctx.moveTo(cx, cy);
  ctx.arc(cx, cy, r, start + mAngle, start + Math.PI * 2);
  ctx.closePath();
  ctx.fill();
  ...
  ageData.forEach((d, i) => {
    ...
    ctx.fillStyle = "#f1f5f9";
    rrect(ctx, bx + 40, y, bMaxW, bH, 3);
    ctx.fill();
    ctx.fillStyle = d.color;
    rrect(ctx, bx + 40, y, Math.max(bw, 6), bH, 3);
    ctx.fill();
    ctx.fillStyle = "#1e293b";
    ctx.font = "bold 10px Arial";
    ctx.textAlign = "left";
  ...
  contractData.forEach((d, i) => {
    ...
    ctx.fillText(d.label, bx, y + bH / 2);
    ctx.fillStyle = "#f1f5f9";
    rrect(ctx, bx + 60, y, bMaxW, bH, 3);
    ctx.fill();
    ctx.fillStyle = d.color;
    rrect(ctx, bx + 60, y, Math.max(bw, 6), bH, 3);
    ctx.fill();
    ctx.fillStyle = "#1e293b";
    ctx.font = "bold 10px Arial";
    ctx.textAlign = "left";
